        ...
        <div id="default-carousel" class="relative w-full" data-carousel="slide">
          ...
          <div class="relative overflow-hidden rounded-lg md:h-auto min-h-96">
              ...
              <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <a href="#" class="absolute w-full grid grid-cols-1 gap-6 sm:grid-cols-2 bg-white border-gray-200">
                  <div class=" md:px-0 md:order-none lg:order-none order-2">
                      <h2 class="mb-2  md:text-5xl font-bold tracking-tight text-gray-900 text-3xl">Noteworthy technology acquisitions 2021</h2>
                      <p class="md:my-6 font-normal text-gray-700 ">What makes quick commerce quick? We stand for swift personalised delivery solutions for our customers, partners and employees. Learn how we empower authentic lifestyles and drive innovation across the globe.</p>
                  </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div class="max-w-full ">
                ...
                <div class="py-5 pl-0 ">
                    ...
                    <a href="#">
                        <h5 class="py-4 w-5/6 mb-2 md:text-xl font-bold tracking-tight text-gray-900 ">How foodpanda CFO Jamie O’Mahony is Navigating 2024</h5>
                    </a>
                    <p class="mb-3 font-normal text-gray-700 ">17 Jan 2024</p>
