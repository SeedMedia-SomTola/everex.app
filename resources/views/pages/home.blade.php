...
@section('content')
  ...
  <section class="section__text m-section card max-w-screen-xl sm:mx-auto md:py-12 my-10 md:px-4">
    <div class="sm:mx-4 grid grid-cols-1 gap-6 sm:grid-cols-2 bg-white border-gray-200">
        <img data-aos="fade-right" class="object-cover w-full rounded-t-lg h-96 md:h-auto" src="{{url('assets/images/dsd.jpg')}}" alt="">
  ...
  <section class="section__text m-section card max-w-screen-xl sm:mx-auto md:py-12 my-10 md:px-4">
        <div class="sm:mx-4 grid grid-cols-1 gap-6 sm:grid-cols-2 bg-white border-gray-200">
            ...
            <img data-aos="fade-right" class="md:order-none lg:order-none order-1 object-cover w-full rounded-t-lg h-96 md:h-auto" src="{{url('assets/images/ap.jpg')}}" alt="">
        </div>
  </section>

  <section class="section__text m-section card max-w-screen-xl sm:mx-auto md:py-12 my-10 md:px-4">
        <div class="sm:mx-4 grid grid-cols-1 gap-6 sm:grid-cols-2 bg-white border-gray-200">
            <img data-aos="fade-right" class="object-cover w-full rounded-t-lg h-96 md:h-auto" src="{{url('assets/images/real_time_tracking.jpg')}}" alt="">
            <div class="" data-aos="fade-right">
...
{{--  </section>--}}
  ...
  <section class="section__text m-section card max-w-screen-xl sm:mx-auto md:py-12 my-10 md:px-4">
        <div class=" grid grid-cols-1 gap-6 sm:grid-cols-2 bg-white border-gray-200">
            ...
            <img data-aos="fade-right" class="object-cover w-full rounded-t-lg h-96 md:h-auto " src="{{url('assets/images/rcs.jpg')}}" alt="">
        </div>
  </section>
@endsection
